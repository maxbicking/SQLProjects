/*
Write a query that lists each product, category, and subcategory; ranks overall list price, as well
as price within each category, and determines if the product is one ot the top 5 most expensive items. 
*/
...
/*
Modify the previous query and use DENSE_RANK instead of RANK
*/
...
/*
Return a true top 5 products by price, assuming we want to see the 
